  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F172A] via-[#1E293B] to-[#0F172A] relative">
      ...
      <div className="lg:ml-[260px]">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl px-4 lg:px-6 py-3 lg:py-4 flex items-center justify-between gap-3">
            ...
            <div className={`flex-1 transition-all duration-300 ${isSearchOpen? 'max-w-[500px] opacity-100' : 'max-w-0 opacity-0'} hidden md:block`}>
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setIsSearchOpen(false)} // fecha ao clicar fora
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2.5 lg:p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition"
              >
              ...
              {/* BTN USER */}
              <button className="hidden sm:flex items-center gap-2 p-2.5 lg:p-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition">
              ...
              <button
                ...
                className="p-2.5 lg:p-3 bg-red-500/10 border border-red-500/20 rounded-xl hover:bg-red-500/20 transition"
              >
        ...
        {/* CONTEUDO COM PADDING-TOP POR CAUSA DO HEADER FIXO */}
