...
const StatCard = ({ title, value, icon: Icon, color }: any) => (
    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-white/20 transition group">
...
export default function Dashboard() {
    const escolas = [
        ...
        { id: 4, nome: 'Centro Educacional Kilamba', provincia: 'Luanda', alunos: 3120, status: 'Ativa', plano: 'Premium' },
    ]
    ...
    return (
        <div className="space-y-6">
            ...
            {/* TABELA DE ESCOLAS GLASS */}
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6">
                <div className="flex justify-between items-center mb-6">
                    <p className="font-bold text-white text-lg">Escolas Cadastradas</p>
                    <div className="flex gap-2">
                        <button className="text-xs bg-white/5 border border-white/10 px-3 py-1.5 rounded-lg text-gray-300">Todas</button>
