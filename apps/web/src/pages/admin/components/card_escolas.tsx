        ...
        <>
            <div
                className="
                    ...
                    transition-all
                    duration-300
                    hover:border-[#3B82F6]/60 hover:bg-white/10
                    mx-auto
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-2 border-t border-white/10 pt-3">
                    <button
                        onClick={onView}
                        className="hidden w-full items-center justify-center gap-1.5 rounded-lg border border-white/10 bg-white/5 p-2 text-xs font-semibold text-gray-300 transition hover:bg-white/10 md:flex"
                    >
