...
export default function StatCard({ title, value, icon: Icon, color }: StatCardProps) {
    return (
        <div className="bg-white/5 backdrop-blur-xl border-white/10 rounded-2xl p-3 hover:border-white/20 transition-all duration-300 w-[85vw] max-w-sm snap-center shrink-0 md:w-full">
