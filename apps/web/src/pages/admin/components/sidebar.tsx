...
import { NavLink } from 'react-router-dom' // ou use next/link
    ...
    return (
        <>
            ...
            <aside className={`
                ...
                /* Mobile: 100% | Tablet: 80% | Desktop: 260px normal */
                w-full sm:w-[80%] md:w-64 lg:w-72
                md:relative md:translate-x-0 md:border-r md:border-white/10
            `}>
                {/* Header */}
