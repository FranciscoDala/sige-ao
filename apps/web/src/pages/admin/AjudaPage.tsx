import { BookOpen, MessageCircleQuestion, Phone, Mail, ShieldCheck, ChevronRight } from 'lucide-react'
...
export default function AjudaPage() {
    ...
    return (
        <div className="space-y-4">
            ...
            <div>
                <h2 className="text-2xl font-bold text-white">Ajuda</h2>
                <p className="text-sm text-gray-400">Tire suas dúvidas e encontre suporte sobre o sige</p>
            </div>

            {/* Cards de Contato */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="bg-white/5 backdrop-blur-xl border-white/10 p-4 rounded-2xl hover:bg-white/10 hover:border-white/20 transition">
                    <BookOpen className="w-7 h-7 text-[#3B82F6] mb-2" />
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-4 rounded-2xl hover:bg-white/10 hover:border-white/20 transition">
                    <Mail className="w-7 h-7 text-[#8B5CF6] mb-2" />
                ...
                <div className="bg-white/5 backdrop-blur-xl border-white/10 p-4 rounded-2xl hover:bg-white/10 hover:border-white/20 transition">
                    <Phone className="w-7 h-7 text-[#10B981] mb-2" />
            ...
            {/* FAQ */}
            <div className="bg-white/5 backdrop-blur-xl border-white/10 p-4 rounded-2xl">
                <h2 className="text-base font-bold text-white mb-3 flex items-center gap-2">
                    <MessageCircleQuestion className="w-4 h-4 text-[#3B82F6]" /> Perguntas Frequentes
                </h2>
                    ...
                    {faqs.map((item, i) => (
                        <details key={i} className="bg-white/5 p-3 rounded-xl group cursor-pointer hover:bg-white/10 transition">
                            <summary className="text-white font-medium text-sm list-none flex justify-between items-center">
                                {item.q}
                                <ChevronRight className="w-3.5 h-3.5 text-gray-400 group-open:rotate-90 transition" />
                            </summary>
            ...
            {/* Info do Sistema - CORRIGIDO: faltava 'border' */}
