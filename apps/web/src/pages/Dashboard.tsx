...
export default function Dashboard() {
  ...
  const inputClass = "w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-[#FFD700]"
              ...
              {escolas.map(escola => (
                <div key={escola.id} className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-5 hover:border-[#FFD700]/50 transition">
                  ...
                  <div className="flex gap-2 mb-4">
                    ...
                    <div title="Cor Secundária" className="w-6 h-6 rounded border border-white/20" style={{background: escola.cor_secundaria}}/>
