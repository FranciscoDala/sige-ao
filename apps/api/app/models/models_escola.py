...
class Escola(Base):
    ...
    id_curto: Mapped[str] = mapped_column(
        String(10),
        unique=True,
        nullable=False,
        index=True,
    ...
    usuarios: Mapped[list["UsuarioEscola"]] = relationship(
        "UsuarioEscola",
...
class Usuario(Base):
    ...
    escolas: Mapped[list["UsuarioEscola"]] = relationship(
        "UsuarioEscola",
...
class UsuarioEscola(Base):
    ...
    escola_id: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True),
